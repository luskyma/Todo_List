...
class TodoListsControllerTest < ActionController::TestCase
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post :create, todo_list: { completed: @todo_list.completed, due_date_time: @todo_list.due_date_time, task: @todo_list.task }
    end
  ...
  test "should update todo_list" do
    patch :update, id: @todo_list, todo_list: { completed: @todo_list.completed, due_date_time: @todo_list.due_date_time, task: @todo_list.task }
    assert_redirected_to todo_list_path(assigns(:todo_list))
  end
